...
\begin{itemize}
    \item Architected and built pipelines from on-premise databases into
          ...
          client's gaming platform with the game brands belonging to the
          business that had
...
\begin{itemize}
    \item Led a small team to launch an internal competitive intelligence tool
          for Sainsbury's, allowing purchasers to review how competitive their
...
\begin{itemize}
    \item Directed a short documentary about contemporary dance. Wrote an
          advert for Aberlour whisky. Assistant Directed an X-Men prequel
          short.
\end{itemize}
