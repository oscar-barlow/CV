...
\begin{itemize}
    \item Senior engineering role with a remit covering ML governance (ethics, explainability) and ops at Starling
    \item Implemented drift detection on ML models in production
    \item Created an 'accessible ML' framework to increase the amount of ML happening at Starling
...
\begin{itemize}
    \item Led problem discovery, technology selection, design and implementation for a project to relaunch Starling's data systems.
    \item Shipped a streaming platform to export data to an analytics database with millisecond latency, without impacting source databases.
    \item Grew and upskilled data engineering team 4x (including managing external partners).
    \item Improved and increased data exploitation by creating a self-serve system for data analysts and scientists
\end{itemize}
...
\begin{itemize}
    \item Part of a team building a pipeline and web app to make internal documents searchable
\end{itemize}
...
\begin{itemize}
    \item Two-month consultancy contract - delivered an MVP of an internal tool for reconciling employee data from different sources.
\end{itemize}

\subsection*{Freelance Filmmaker}
\textbf{May 2014 - September 2016}
\begin{itemize}
    \item Directed a short documentary about contemporary dance. Wrote an advert for Aberlour whisky. Assistant Directed an X-Men prequel short.
\end{itemize}

\subsection*{Marketing Manager - Various Companies}
\textbf{June 2009 - April 2014}
\begin{itemize}
    \item Strategically repositioned a small web agency prior to its acquisition.
    \item Managed schedule of digital content and web events across Europe for an enterprise software vendor.
    \item Relaunched a self-published software product for people with specific learning difficulties, for a small software reseller/publisher.
\end{itemize}
...
\begin{itemize}
    \item Part-time business masters degree, completed while working full time. Dissertation: brand development for tech(-enabled) startups. Grade: distinction.
\end{itemize}

\subsection*{BA (Hons) Philosophy - University of Nottingham}
\textbf{September 2005 - June 2008}
\begin{itemize}
    \item Broad degree in which I studied formal logic, ethics, and cultural theory.
\end{itemize}
