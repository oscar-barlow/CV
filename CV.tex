...
\begin{itemize}
      \item Two-month consultancy contract - delivered an MVP of an internal
            tool
...
\begin{itemize}
      \item Strategically repositioned a small web agency prior to its
            acquisition.
      \item Managed schedule of digital content and web events across Europe
            for
            an enterprise software vendor.
      \item Relaunched a self-published software product for people with
            specific
...
\begin{itemize}
      \item Part-time business masters degree, completed while working full
            time.
