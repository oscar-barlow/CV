...
\begin{itemize}
	\item Expanded access to data and data-led decision making, including in some areas that were previously data starved, by designed and implemented a streaming data platform (Kafka) and data warehouse (BigQuery, dbt) with minimal resources
